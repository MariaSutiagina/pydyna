...
class MonsterFactory(metaclass=MetaSingleton):
    def __init__(self):
        self.config = {
            ...
            100: {'lives':3, 'speed': 1, 'direction_change_factor':3, 'can_fly': 0, 'is_boss': 1, 'is_chain': 4, 'has_children':0, 'pregnancy_duration':0},
            4: {'lives':1, 'speed': 2, 'direction_change_factor':6, 'can_fly': 0, 'is_boss': 0, 'is_chain': 0, 'has_children':0, 'pregnancy_duration':0},
